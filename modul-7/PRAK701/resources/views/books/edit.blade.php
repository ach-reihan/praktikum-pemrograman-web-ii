...
@section('title', 'Ubah Buku - Perpustakaan Reihan')

@section('content')
<div class="max-w-xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        <h3 class="text-2xl font-extrabold text-slate-800">Ubah Detail Buku</h3>
    ...
    <div class="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
        <form action="{{ route('books.update', $book->id) }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input type="number" id="publish_year" name="publish_year" value="{{ old('publish_year', $book->publish_year) }}" 
